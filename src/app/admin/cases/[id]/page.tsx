      ...
      <section className="grid gap-4">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur p-5">
          ...
          <form action={markStatusAction} className="mt-4 grid md:grid-cols-[1fr_auto_auto] gap-2 items-center">
            ...
            <button className="rounded-xl bg-[color:var(--mm-gold)] px-4 py-2 font-semibold text-[color:var(--mm-ink)] w-fit shadow-[0_10px_30px_rgba(213,166,63,0.20)] hover:brightness-105 active:brightness-95">Salvar status</button>
          </form>
